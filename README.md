...
optional arguments:
  -n                    Number of protein copies in the system, default 1.

  -skip                 The number of frames to skip, default 1.

  -vtraj                Set to True for a trajectory of the vectors,
			default False.
  ...
  -nprocs               Number of processes to use, default=1.
  ...
  -sec_struc_choice     A file containing the choice of secondary srtucture
